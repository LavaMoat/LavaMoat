...
/**
 * Options having a `readPowers` property also accepting an `fs`-like object.
 */
export interface WithReadPowersOrFs {
  /**
   * Read powers to use when loading the compartment map.
   */
...
export type GeneratePolicyOptions = Simplify<
  ArchiveOptions & WithReadPowersOrFs & WithPolicyOverride & WithDebug
>
...
export type GenerateAndWritePolicyOptions = Simplify<
  GeneratePolicyOptions & WritePolicyOptions
>
