...
test.skip('arguments - lavamoat command aliases work - autoconfig', async (t) => {
...
test.skip('arguments - lavamoat command aliases work - advanced', async (t) => {
  const scenario = createScenarioFromScaffold({
    defineOne: () => {
      module.exports = 5
    },
...
test.skip('arguments - invalid lavamoat commands fail', async (t) => {
  const scenario = createScenarioFromScaffold({
    defineOne: () => {
      module.exports = 5
    },
