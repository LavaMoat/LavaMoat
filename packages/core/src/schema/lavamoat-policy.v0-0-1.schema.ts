 ...
 *
 * @template T The value of {@link LavaMoatPolicy.resources}; the keys of this
 *   object must be present here
 */
export type PolicyHints<T extends Resources = Resources> = {
  [k in keyof T]?: string[]
}
