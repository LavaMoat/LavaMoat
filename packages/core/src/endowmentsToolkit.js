...
function endowmentsToolkit({
  ...
  function copyWrappedGlobals(
    ...
    Object.entries(endowmentDescriptorsFlat)
      ...
      .forEach(([key, desc]) => {
        // NOTE: In case you're thinking about triggering lazy getters here to
        // avoid duplicated iteration. We'd need to hold on to the object we
        // got them from and read back the new descriptor after triggering the
        // getter to replace the one we've collected. That's likely more work
