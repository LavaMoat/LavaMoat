...
class LavaMoat {
  ...
  async handleEmit (compilation) {
    ...
    // mainTemplate.hooks.require.tap('LavaMoat', (source, chunk, hash) => {
    //   return 'console.log("bingbong", moduleId)'
    // })
...
//
// below from https://github.com/GoogleChrome/workbox/blob/master/packages/workbox-webpack-plugin/src/lib/get-manifest-entries-from-compilation.js
//
