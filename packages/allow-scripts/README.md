...
Adds a `.yarnrc` or `.npmrc` (depending on which lockfile is present) to the package, populates this file with the configuration to disallow lifecycle scripts.
