...
import { action, hrPath, seconds, stripAnsi, success } from './format.js'
      ...
      (yargs) =>
        yargs
          ...
          .options({
            ...
            concurrency: {
              describe: 'Max number of concurrent threads [EXPERIMENTAL]',
              type: 'number',
              coerce: Number,
              group: BEHAVIOR_GROUP,
      ...
      (yargs) =>
        yargs
          .options({
            ...
            concurrency: {
              describe: 'Max number of concurrent threads',
              type: 'number',
              coerce: Number,
              group: BEHAVIOR_GROUP,
              default: Math.max(1, availableParallelism() - 1),
