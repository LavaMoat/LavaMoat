...
testInspect(
  'doesnt detect properties on "this"',
  {},
  () => {
    this.xyz
  },
...
testInspect(
  'detects reads on multiple globalRefs',
  {
    globalRefs: ['a', 'b', 'c'],
  },
  () => {
...
testInspect(
  'detects implicit global writes',
  {},
  () => {
    xyz = true
  },
...
testInspect(
  'detects implicit global writes with mixed usage',
  {},
  () => {
    z = xyz
    xyz = (function (a) {
...
testInspect(
  'detects assignment to property on globalRefs',
  {
    globalRefs: ['zzz'],
  },
  () => {
...
testInspect(
  'never suggest access to full globalRef',
  {
    globalRefs: ['zzz'],
  },
  () => {
...
testInspect(
  'detects combined globalRef assignment and reads',
  {
    globalRefs: ['zzz'],
  },
  () => {
...
testInspect(
  'not picking up assignments to non-global matching globalRef name',
  {
    globalRefs: ['xyz'],
  },
  () => {
...
testInspect(
  'elevating computed property lookups to globalRef 1',
  {
    globalRefs: ['abc'],
  },
  () => {
...
testInspect(
  'elevating computed property lookups to globalRef 2',
  {
    globalRefs: ['abc'],
  },
  () => {
...
testInspect(
  'picking up mixed explicit and computed property lookups',
  {
    globalRefs: ['window'],
  },
  () => {
...
testInspect(
  'not picking up js language features',
  {
    globalRefs: ['window'],
  },
  () => {
...
testInspect(
  'ignore globalRef without property lookup',
  {
    globalRefs: ['window'],
  },
  () => {
...
testInspect(
  'take platform api, up to computed',
  {
    globalRefs: ['window'],
  },
  () => {
...
testInspect(
  'correctly finds deep "process.env" reference',
  {},
  () => {
...
testInspect(
  'read access to object implies write access to properties',
  {},
  () => {
    const x = location
...
testInspect(
  'object destructuring with branching',
  {
    globalRefs: ['globalThis'],
  },
  () => {
...
testInspect(
  'new intrinsics like BigInt are ignored',
  {
    globalRefs: ['globalThis'],
  },
  () => {
