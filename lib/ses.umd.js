(function (global, factory) {
  ...
  function createSafeEvaluatorFactory(
    ...
    function factory(endowments = {}, options = {}) {
      const {
        transforms: optTransforms,
        sloppyGlobals: optSloppyGlobals
      } = options;
      const localTransforms = optTransforms || [];
      ...
      const endowmentState = allTransforms.reduce(
        ...
        { endowments, sloppyGlobals: optSloppyGlobals || realmSloppyGlobals }
      );
      endowments = endowmentState.endowments;
      const sloppyGlobals = endowmentState.sloppyGlobals;
